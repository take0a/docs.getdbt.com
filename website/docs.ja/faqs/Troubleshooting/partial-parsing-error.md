...
このエラーが発生した場合は、プロジェクトから `target/partial_parse.msgpack` ファイルを削除し、IDE を更新してみてください。

上記の回避策を試してもこの現象が続く場合は、サポートチーム（support@getdbt.com）までお問い合わせください。喜んでお手伝いいたします。
