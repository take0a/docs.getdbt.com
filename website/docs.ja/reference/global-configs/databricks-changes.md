...
The following are the current [behavior change flags](/docs.ja/reference/global-configs/behavior-changes.md#behavior-change-flags) that are specific to `dbt-databricks`:
